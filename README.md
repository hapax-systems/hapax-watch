...
Constituent of the Hapax operating environment. Wear OS companion that streams biometric sensor data (heart rate, HRV, skin temperature, sleep) to the council logos API. Single operator, single device.
